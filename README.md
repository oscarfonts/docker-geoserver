...
* [`latest`, `2.21.2` (*2.21.2/Dockerfile*)](https://github.com/oscarfonts/docker-geoserver/blob/master/2.21.2/Dockerfile)
...
See some [examples](https://github.com/oscarfonts/docker-geoserver/tree/master/2.21.2/conf).
