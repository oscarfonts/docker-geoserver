...
* [`latest`, `2.22.0` (*2.22.0/Dockerfile*)](https://github.com/oscarfonts/docker-geoserver/blob/master/2.22.0/Dockerfile)
...
See some [examples](https://github.com/oscarfonts/docker-geoserver/tree/master/2.22.0/conf).
