...
* [`latest`, `2.17.1` (*2.17.1/Dockerfile*)](https://github.com/oscarfonts/docker-geoserver/blob/master/2.17.1/Dockerfile)
* [`2.16.3` (*2.16.3/Dockerfile*)](https://github.com/oscarfonts/docker-geoserver/blob/master/2.16.3/Dockerfile)
...
See some [examples](https://github.com/oscarfonts/docker-geoserver/tree/master/2.17.1/conf).
